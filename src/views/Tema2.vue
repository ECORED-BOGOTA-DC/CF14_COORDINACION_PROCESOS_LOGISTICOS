...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .cajon.color-acento-contenido.mt-4.p-4(style="background-color:#DDF8F7;") 
      p.mb-0(data-aos="zoom-in") Actualmente, el campo logístico está siendo afectado positivamente por el desarrollo de nuevas tecnologías, en procesos tales como:
    ...
    p.mt-5(data-aos="zoom-in") En la siguiente tabla se presentan las especificaciones mínimas de las trazabilidades:
    ...
    p.mt-5.text-center.fw-bold(data-aos="zoom-in") La estructura de los sistemas de gestión de calidad se ilustra en la siguiente figura, que muestra los diferentes elementos involucrados.
    ...
    .cajon.color-primario.mt-5.p-4(style="background-color:#F2F6FE;") 
      p.mb-0(data-aos="zoom-in") El objetivo de las Normas OHSAS 18001:2007 es el mejoramiento de la seguridad y la salud en todos los lugares de trabajo, mediante una gestión estructurada y sistemática, que es complementaria y compatible con los sistemas de gestión de calidad y medio ambiente. 
    ...
    .row.mt-5
      ...
      .col-lg-9(style="place-self:center;")
        ...
        ul.lista-ul.mt-3.ps-md-4(data-aos="zoom-in")
          li 
            i.fas.fa-check
    ...
    p.mt-5(data-aos="zoom-in") Esta norma señala los principios y establece los requisitos mínimos o básicos para el diseño y la ejecución de un sistema de trazabilidad de toda la cadena alimentaria. En este sentido, puede aplicarse por una institución u organización que actúe en cualquier etapa de la mencionada cadena. 
    ...
    .row.mt-5
      ...
      .col-lg-9(style="place-self:center;")
        ...
        .cajon.color-primario.mt-4.p-4(style="background-color:#F2F6FE;") 
          p.mb-0(data-aos="zoom-in") Para la definición del sistema de trazabilidad se presentan las siguientes definiciones en el recurso de aprendizaje:
    ...
    p.mt-5(data-aos="zoom-in") En la siguiente figura se presentan las fases para la aplicación de un sistema de trazabilidad:
    ...
    .bloque-texto-g.bloque-texto-g--inverso.color-secundario.p-3.p-sm-4.p-md-5(data-aos="flip-up")
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/tema2/52.png')})`}"
      )
      .bloque-texto-g__texto.p-4
    ...
    p(data-aos="zoom-in") Con relación al sistema de trazabilidad que se implemente en una empresa desde la etapa anterior hasta la posterior debe ayudar a sostener la trazabilidad en toda la cadena alimentaria. Así las cosas, dependiendo del tipo de actividad dentro de la mencionada cadena, el sistema puede requerir:
    ...
    p(data-aos="zoom-in") Es necesario que cada empresa agrupe el registro de productos conforme lo establezca el conjunto de unidades que produce, hace, envasa o maneja en general. Se debe dejar registro detallado de dicha agrupación, la cual se denomina normalmente “partida” o “lote”. 
    ...
    .bloque-texto-g.color-acento-contenido.p-3.p-sm-4.p-md-5.mt-5(data-aos="flip-up")
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/tema2/63.png')})`}"
      )
      .bloque-texto-g__texto.p-4
    ...
    p.mt-5(data-aos="zoom-in") Si las empresas tienen un sistema de registro y autocontrol oportuno pueden ser considerados como una herramienta fundamental de gestión de los riesgos alimentarios, que podrá ayudar al montaje del sistema de trazabilidad. 

    .bloque-texto-g.color-secundario.p-3.p-sm-4.p-md-5.mt-5(data-aos="flip-up")
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/tema2/65.png')})`}"
      )
      .bloque-texto-g__texto.p-4
    ...
    .bloque-texto-g.color-acento-contenido.p-3.p-sm-4.p-md-5.mt-5(data-aos="flip-up")
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/tema2/68.png')})`}"
      )
      .bloque-texto-g__texto.p-4
